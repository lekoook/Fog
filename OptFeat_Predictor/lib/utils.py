...
def extract_dwtfeat(wy, ay, az):
    ...
    return wy_cA_var, wy_var, ay_cA_mean
...
def extract_sepfeat(window):
    ...
    wy_cA_var, wy_var, ay_cA_mean = extract_dwtfeat(rwy, ray, raz)
